...
* `def to_dictionary(self)` - Returns a dictionary containing all keys/values of the instance
...
## `/models/engine` Directory containing File Storage class that handles JASON serialization and deserialization
